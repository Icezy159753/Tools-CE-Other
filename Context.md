...
4. เมื่อเปิดโปรแกรม ระบบจะเช็กอัปเดตอัตโนมัติ
5. ถ้า tag เวอร์ชันใหม่กว่าเวอร์ชันปัจจุบัน โปรแกรมจะแจ้งผู้ใช้ทันที
6. ผู้ใช้กดตกลงแล้ว updater จะจัดการแทนไฟล์เดิมให้
